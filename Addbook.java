...
public class Addbook extends JFrame implements ActionListener
{
	...
	public Addbook(String userId)
	{
		...
		yearlabel = new JLabel("publicationYear : ");
		yearlabel.setBounds(250, 290, 150, 30);
		panel.add(yearlabel);
		
		yearTF = new JTextField();
		yearTF.setBounds(400, 290, 85, 30);
		panel.add(yearTF);
	...
	{
		String newId = userTF.getText();
		String query1 = "DELETE from booklist WHERE bookId='"+newId+"';";
